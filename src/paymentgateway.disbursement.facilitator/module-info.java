module paymentgateway.disbursement.facilitator {
	...
	exports paymentgateway.disbursement.facilitator;
	...
	opens paymentgateway.disbursement.facilitator to org.hibernate.orm.core, gson;
}