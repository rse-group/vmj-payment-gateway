...
public class ConfigFactory{
    ...
    public static Config createConfig(Object ... base)
    {   
        String productName = PropertiesReader.getProductName();
        String fullyQualifiedName = "paymentgateway.config." + productName.toLowerCase() + "." + productName + "Configuration";
        Config record = null;
        try {
            Class<?> clz = Class.forName(fullyQualifiedName);
            Constructor<?> constructor = clz.getDeclaredConstructors()[0];
