package paymentgateway.disbursement.exchangerate;
...
public class DisbursementResourceImpl extends DisbursementResourceDecorator{
	...
	@Route(url="call/exchangerate/detail")
	...
	@Route(url="call/exchangerate/list")
	...
	@Route(url="call/exchangerate/delete")
	...
	@Route(url="call/exchangerate/update")
