...
public class MoneyTransferResourceImpl extends DisbursementResourceDecorator {
	...
	public MoneyTransferResourceImpl(DisbursementResourceComponent record) {
		super(record);
		this.moneyTransferRepository = new RepositoryUtil<MoneyTransferImpl>(
				paymentgateway.disbursement.moneytransfer.MoneyTransferImpl.class);
	}
	...
	// GetAllDisbursementResponse dosmmesticData =
	// record.getAllDataFromAPI("disbursement");
	// GetAllDisbursementResponse internationalData =
	// record.getAllDataFromAPI("international-disbursement");
	// List<MoneyTransferResponse> dosmesticTransferData = dosmmesticData.getData();
	// List<MoneyTransferResponse> internationalTransferData =
	// internationalData.getData();
	...
	// try {
	// MoneyTransferImpl moneyTransfer =
	// getPendingMoneyTransferById(moneyTransfers,id);
	...
	// public MoneyTransferImpl getPendingMoneyTransferById(List<MoneyTransferImpl>
	// moneyTransfers, int id){
	...
	// List<MoneyTransferImpl> moneyTransfers =
	// moneyTransferRepository.getAllObject("moneytransfer_impl");
	// for(MoneyTransferImpl moneyTransfer : moneyTransfers){
