package paymentgateway.disbursement.multiplemoneytransfer;
...
public class MultipleMoneyTransferResourceImpl extends DisbursementResourceDecorator {
	// implement this to work with authorization module
	protected String apiKey;
	protected String apiEndpoint;

	public MultipleMoneyTransferResourceImpl(DisbursementResourceComponent record) {
		super(record);
	}

	public List<Disbursement> createDisbursement(VMJExchange vmjExchange) {
//		List<HashMap<String,Object>> requests = vmjExchange.getRequestBodyForm("data");
...
//			disbursements.add(moneyTransferTransaction);
//
//		}
...
//				.collect(Collectors.joining("&"));
	...
	@Route(url = "test/call/moneytransfer/multiple")
	public List<HashMap<String, Object>> moneyTransfer(VMJExchange vmjExchange) {
...
//		testExchange.put("amount", amount);
		List<Disbursement> result = this.createDisbursement(vmjExchange);
