package paymentgateway.product.rustle;
...
public class Rustle {
	private static final Logger LOGGER = Logger.getLogger(Rustle.class.getName());
	...
	public static void createObjectsAndBindEndPoints() {
		...
		DisbursementResource aggregatormoneytransfer = DisbursementResourceFactory
				.createDisbursementResource(
		...
		Router.route(aggregatormoneytransfer);

		LOGGER.info("Binding Payment endpoints");
		Router.route(payment);

		LOGGER.info("Binding EWallet endpoints");
