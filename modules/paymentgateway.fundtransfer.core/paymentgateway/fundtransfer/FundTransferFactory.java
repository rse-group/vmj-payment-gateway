...
public class FundTransferFactory{
    ...
    public FundTransferFactory()
    {

    }

    public static FundTransfer createFundTransfer(String fullyQualifiedName, Object ... base)
    {
        FundTransfer record = null;
        try {
            ...
            for (int i = 0; i < constructorList.length; i++) {
                try {
                    ...
                    record = (FundTransfer) constructor.newInstance(base);
                    break;
