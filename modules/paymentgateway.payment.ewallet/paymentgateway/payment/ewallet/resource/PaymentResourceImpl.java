...
public class PaymentResourceImpl extends PaymentResourceDecorator {
	...
	@Route(url = "call/ewallet/vendorname", method = RequestMethod.GET)
	public List<EWalletImpl> getByVendorName(VMJExchange vmjExchange) {
		Map<String, String> queryParams = vmjExchange.queryToMap();
		return paymentServiceImpl.getByVendorName(queryParams);
	}

	@Route(url = "call/ewallet/detail", method = RequestMethod.GET)
