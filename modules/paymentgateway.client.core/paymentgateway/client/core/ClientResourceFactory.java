...
public class ClientResourceFactory{
    private static final Logger LOGGER = Logger.getLogger(ClientResourceFactory.class.getName());
    ...
    public static ClientResource createClientResource(String fullyQualifiedName, Object ... base)
    {
    	ClientResource record = null;
        try {
            ...
            for (int i = 0; i < constructorList.length; i++) {
                try {
                    ...
                    record = (ClientResource) constructor.newInstance(base);
                    break;
