...
public class PaymentResourceImpl extends PaymentResourceDecorator {
	...
	@Route(url="call/retailoutlet", method = RequestMethod.POST)
	...
	@Route(url = "call/retailoutlet/vendorname", method = RequestMethod.GET)
	public List<RetailOutletImpl> getByVendorName(VMJExchange vmjExchange) {
		Map<String, String> queryParams = vmjExchange.queryToMap();
		return paymentServiceImpl.getByVendorName(queryParams);
	}

	@Route(url = "call/retailoutlet/detail", method = RequestMethod.GET)
