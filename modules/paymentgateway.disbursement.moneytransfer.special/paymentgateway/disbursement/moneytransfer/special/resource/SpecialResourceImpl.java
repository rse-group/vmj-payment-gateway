package paymentgateway.disbursement.moneytransfer.special;
...
public class SpecialResourceImpl extends DisbursementResourceDecorator {
	...
	// "Basic
	// SkRKNUpERXpKR3A0YlU5WVppNU9kRGRuU0VoU2JYbFBibXhEVVM1VVJGaHRTM0pEZFZwc2NWVTFMemgxUldwSVVqVldielpMYkhOMkwybDE=")
	...
	// paramList.add(key + "=" + URLEncoder.encode(val.toString(),
	...
	// paramList.add(key + "=" + URLEncoder.encode(Integer.toString(temp),
	// StandardCharsets.UTF_8));
	// }
	//
	// }
